      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center">
          ...
          <p className="hero-description text-lg md:text-xl text-khaki-light max-w-3xl mx-auto mb-12 leading-relaxed">
            Enterprise-grade automation delivers measurable ROI, eliminates manual work, and empowers your team to focus on strategic growth. Discover why 500+ processes are already automated with LambdaFlows.
          </p>
