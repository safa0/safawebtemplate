      ...
      <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="solutions-hero-description text-xl text-gray-700 leading-relaxed max-w-xl mb-8">
            From process discovery to enterprise-wide automation, LambdaFlows delivers end-to-end automation solutions designed to maximize ROI, minimize risk, and drive measurable business outcomes.
          </p>
