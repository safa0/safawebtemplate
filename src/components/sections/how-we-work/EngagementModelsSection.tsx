...
const models: EngagementModel[] = [
  {
    title: "Project-Based",
    description: "Focused engagement to validate TinySentinel on a target device or site with defined scope, timeline, and deliverables",
    bestFor: "Single board/line pilot or discrete product integration",
    features: [
      "Fixed scope and budget",
      "Target device threat model",
      "Bench and hardware-in-loop tests",
      "Knowledge transfer included",
      "Post-launch support (30 days)",
    ],
    timeline: "6-12 weeks",
    investmentRange: "Scoped per device",
    icon: "📋",
  },
  {
    title: "Managed Services",
    description: "Ongoing partnership for continuous model tuning, telemetry reviews, and fleet monitoring",
    bestFor: "Organizations deploying TinySentinel across device fleets",
    features: [
      "Monthly delivery cadence",
      "Dedicated security & firmware team",
  ...
  },
  {
    ...
    description: "Build in-house capability to maintain and extend on-device IDS across products",
    bestFor: "Teams wanting to internalize TinySentinel practices across multiple products",
    features: [
