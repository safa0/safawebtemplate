        ...
        <div className="story-content grid md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-lg text-khaki-dark leading-relaxed mb-6">
              LambdaFlows™ was born from a vision to revolutionize how enterprises approach automation. Our founders, with over 50 years of combined experience in enterprise technology and process optimization, recognized a critical gap in the market.
            </p>
