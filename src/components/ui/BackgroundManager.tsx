...
export function BackgroundManager() {
  ...
  useEffect(() => {
    const sections = [
      ...
      { trigger: ".problem-section", bg: "floral" as BackgroundType },
      { trigger: ".benefits-section", bg: "concrete" as BackgroundType },
      { trigger: ".tiers-section", bg: "neutral" as BackgroundType },
